...
중요: 반드시 앞으로 일어날 일을 예측하는 미래형 운세여야 합니다 ("~하게 될 것입니다", "~할 조짐이 보입니다", "~하면 좋겠습니다" 등). 이미 지나간 일을 회상하는 과거형 일기·에세이 문체는 절대 쓰지 마세요.
title은 짧은 한 줄 헤드라인이어야 합니다 (예: "뜻밖의 손님이 찾아옵니다"). 완전한 문단이 아니라 신문 운세란 제목처럼 짧게 쓰세요.
아래 JSON 형식으로만 답하세요. 다른 설명은 붙이지 마세요.
{"title":"짧은 한 줄 헤드라인(미래형)","body":"운세 본문 (2~3문장, 미래형)"}
${ERA_RULE}
${TONE_RULE}
${langLine}`;
  try {
